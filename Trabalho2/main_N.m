...
% Parametros
offset = 0.01; %offset pra criar os novos pontos da nuvem
expoente_RBF = 1;
variacaoN = [5:120]; %Dimensao do grid onde a funcao sera interpolada no final (nXnXn)

% Funcao RBF
psi = @(r)( r.^expoente_RBF );

% Nome do gif pra ser gerado 
filename = 'gif-teste.gif';

% Vai ler uma matriz P e uma matriz N
...
h = figure;
for n=variacaoN
	textprogressbar(['Calculando no grid com N = ', num2str(n), ': ']);
