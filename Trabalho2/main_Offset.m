...
expoente_RBF = 1;
variacaoOffset = [0.01: (0.5-0.01)/100 :0.5];
...
h = figure;
P_base = P;
for offset=variacaoOffset
	textprogressbar(['Calculando com offset = ', num2str(offset), ': ']);	

	n_p = length(P_base);
	P = [P_base; P_base + offset*N; P_base-offset*N];
